...
;; 1.1 - 26Feb2011 - DM added more colors and regexes

;;; Code:

(require 'iswitchb)

;; use (list-colors-display) to show faces
...
(defface saint/iswitchb-highlight-3-face
  ...
  "*Face used to highlight terms in the iswitchb buffer")
(defface saint/iswitchb-highlight-4-face
  '((t (:foreground "red"))) 
  "*Face used to highlight terms in the iswitchb buffer")
(defface saint/iswitchb-highlight-5-face
  '((t (:foreground "green"))) 
  "*Face used to highlight terms in the iswitchb buffer")
(defface saint/iswitchb-highlight-6-face
  '((t (:foreground "yellow green"))) 
  "*Face used to highlight terms in the iswitchb buffer")
(defface saint/iswitchb-highlight-7-face
  '((t (:foreground "deep sky blue"))) 
  "*Face used to highlight terms in the iswitchb buffer")
(defface saint/iswitchb-highlight-8-face
            ...
            (save-excursion
              ...
              (let* ((match
                ...
                (cond 
                 ...
                 ((= face-num 4) (propertize buf 'face 'saint/iswitchb-highlight-4-face))
                 ((= face-num 5) (propertize buf 'face 'saint/iswitchb-highlight-5-face))
                 ((= face-num 6) (propertize buf 'face 'saint/iswitchb-highlight-6-face))
                 ((= face-num 7) (propertize buf 'face 'saint/iswitchb-highlight-7-face))
                 ((= face-num 8) (propertize buf 'face 'saint/iswitchb-highlight-8-face))
                 (t buf)
                 ))))
